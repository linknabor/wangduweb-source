...
var MasterConfig = function() {
    ...
    var t = {
        ...
        basePageUrlpay:/127|test/.test(location.origin)?'https://test.e-shequ.com/wangdu/weixin/':
...
var Config = function() {
    var t = {
        ...
        user_info: {
            avatar: "http://wuye.gm4life.cn/wangdu/weixin/static/images/logo.jpg",
            nickname: "游客",
            levelname: "普通会员"
        },
        user_level:{
        ...
        coupon:{
            seedImg:"http://wuye.gm4life.cn/wangdu/weixin/static/img/banner/banner_market_shuiguo.jpg"
        }
    },
    e = {};
    return e.C = function(e) {
...
checkBindAndBind();
checkCodeAndLogin();
common.setTitle(MasterConfig.C("shop_name") + "悦社区");
